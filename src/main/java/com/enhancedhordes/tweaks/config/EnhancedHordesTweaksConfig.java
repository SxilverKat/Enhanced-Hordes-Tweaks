...
public class EnhancedHordesTweaksConfig {
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_STACKING = BUILDER
            .comment(
                "Enable horde stacking, mobs climbing on top of each other to scale walls."
            )
            .define("features.enableHordeStacking", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_FIRE_SPREAD = BUILDER
            .comment(
                "Allow horde mobs that are on fire to spread fire to nearby horde mobs on contact."
            )
            .define("features.hordeFireSpread", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_FIRE_SPEED_BOOST = BUILDER
            .comment(
                "Burning horde mobs gain a speed boost."
            )
            .define("features.hordeFireSpeedBoost", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_BABY_FIRE_SPEED_BOOST = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_FIRE_SPEED_AMPLIFIER = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_FIRE_DAMAGE_RESISTANCE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_BABY_BLOCK_BREAKING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_MULTIPLYING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_INTELLIGENT_TEAMS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_LEAPING_MOBS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_INTELLIGENT_PIGLINS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HIDDEN_ZOMBIES = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_BLOCK_BREAKING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_SWIMMING = BUILDER
            .comment(
                "Allow horde mobs to float and swim across water instead of sinking."
            )
            .define("features.enableHordeSwimming", false);

    private static final ForgeConfigSpec.IntValue HORDE_MOB_CAP = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue DISABLE_GAMERULE_COMMANDS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue FEATURES_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ALLOW_FRIENDLY_FIRE_TO_HORDE_MOBS = BUILDER
            .comment(
                "Allow intelligent mobs to deal damage to horde mobs."
            )
            .define("intelligentMobBehaviors.allowFriendlyFireToHordeMobs", true);

    private static final ForgeConfigSpec.BooleanValue ENABLE_ZOMBIFIED_PIGLIN_CROSSBOW = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue INTELLIGENT_MOB_MIN_DASH_DISTANCE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_MULTI_HIT = BUILDER
            .comment(
                "Enable Iron Golems hitting multiple enemies at once with one swing."
            )
            .define("otherMobs.enableIronGolemMultiHit", true);

    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_FIRE_IMMUNITY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_EFFECT_IMMUNITY = BUILDER
            .comment(
                "Enable Iron Golem immunity to Wither, Poison, and Levitation effects."
            )
            .define("otherMobs.enableIronGolemEffectImmunity", true);

    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_ARROW_RESISTANCE = BUILDER
            .comment(
                "Enable Iron Golem arrow resistance."
            )
            .define("otherMobs.enableIronGolemArrowResistance", true);

    private static final ForgeConfigSpec.IntValue IRON_GOLEM_ARROW_RESISTANCE_PERCENT = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_HURRY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_REGEN = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue IRON_GOLEM_REGEN_POWER = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue IRON_GOLEM_REGEN_COOLDOWN_SECONDS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_IRON_GOLEM_VILLAGER_DEFENDER = BUILDER
            .comment(
                "Iron Golems will aggro on any mob that damages a nearby Villager."
            )
            .define("otherMobs.enableIronGolemVillagerDefender", false);

    private static final ForgeConfigSpec.BooleanValue ENABLE_WITHER_SKELETON_BOW_TACTICS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_CREEPER_WALL_EXPLOSION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue CREEPER_WALL_EXPLOSION_DISTANCE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue CREEPER_WALL_EXPLOSION_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> HIDDEN_ZOMBIE_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_BLOCK_REGENERATION = BUILDER
            .comment(
                "Enable regeneration of blocks broken by horde mobs."
            )
            .define("blockRegeneration.enableBlockRegeneration", false);

    private static final ForgeConfigSpec.IntValue REGENERATION_DELAY_SECONDS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue REQUIRE_NEARBY_PLAYERS = BUILDER
            .comment(
                "Only regenerate blocks if a player is within the check radius."
            )
            .define("blockRegeneration.requireNearbyPlayers", false);

    private static final ForgeConfigSpec.IntValue NEARBY_PLAYER_RADIUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue CHECK_ENTITY_COLLISION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue REQUIRE_MOBS_CLEARED_BEFORE_REGEN = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue MOB_CLEARED_RADIUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue CANCEL_REGEN_ON_MOB_RETURN = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue RESET_DELAY_ON_MOB_RETURN = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue SHOW_PRE_REGEN_WARNING_PARTICLES = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue STAGGERED_REGEN = BUILDER
            .comment(
                "When enabled, mob-broken blocks regenerate one at a time in a random order"
            )
            .define("blockRegeneration.staggeredRegen", true);

    private static final ForgeConfigSpec.IntValue STAGGERED_REGEN_INTERVAL_TICKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue SHOW_REGENERATION_PARTICLES = BUILDER
            .comment(
                "Show particles when a block regenerates."
            )
            .define("blockRegeneration.showRegenerationParticles", true);

    private static final ForgeConfigSpec.BooleanValue PLAY_REGENERATION_SOUND = BUILDER
            .comment(
                "Play the block's placement sound when it regenerates."
            )
            .define("blockRegeneration.playRegenerationSound", true);

    private static final ForgeConfigSpec.BooleanValue REGEN_DAYTIME_ONLY = BUILDER
            .comment(
                "Only regenerate blocks during the daytime."
            )
            .define("blockRegeneration.regenDaytimeOnly", false);

    private static final ForgeConfigSpec.BooleanValue REGEN_SCALE_DELAY_BY_HARDNESS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue CANCEL_REGEN_ON_PLAYER_PLACE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue PLAYER_PLACE_CANCEL_RADIUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_MENTALITY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_NIGHT_ONLY = BUILDER
            .comment(
                "Only allow horde mentality block breaking at night."
            )
            .define("hordeMentality.nightOnly", false);

    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_GROUP_RADIUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_DAMAGE_RATE_PER_MOB = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_TIER_DAMAGE_SCALING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_PROGRESSIVE_SCALING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_PROGRESSIVE_SCALING_BONUS_PER_MOB = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_HARDNESS_SCALING = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_DAMAGE_LINGER_SECONDS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_INSTANT_BREAK = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_SWING_INTERVAL_TICKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_HIT_CHANCE_PERCENT = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_REQUIRE_PLAYER_TARGET = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_CHECK_PLAYER_PROXIMITY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_PLAYER_PROXIMITY_RADIUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_REQUIRE_BLOCK_IN_DIRECTION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_BABY_MOBS_CONTRIBUTE = BUILDER
            .comment(
                "Allow baby horde mobs to count toward group size."
            )
            .define("hordeMentality.babyMobsContribute", false);

    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_BABY_MOBS_CAN_BREAK = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_PROTECT_SUPPORTING_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_ALLOW_DIG_DOWN_TO_PLAYER = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_DROP_TIER1_BLOCKS = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_DROP_TIER2_BLOCKS = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_DROP_TIER3_BLOCKS = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_DROP_TIER4_BLOCKS = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_SHOW_BREAK_PARTICLES = BUILDER
            .comment(
                "Spawn block break particles when a block is fully broken by horde mentality."
            )
            .define("hordeMentality.showBreakParticles", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_PLAY_BREAK_SOUND = BUILDER
            .comment(
                "Play the block's break sound when fully broken by horde mentality."
            )
            .define("hordeMentality.playBreakSound", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_PLAY_HIT_SOUND = BUILDER
            .comment(
                "Play the block's hit sound each time a mob successfully damages a block."
            )
            .define("hordeMentality.playHitSound", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_MENTALITY_SHOW_HIT_PARTICLES = BUILDER
            .comment(
                "Spawn block chip particles each time a mob successfully damages a block."
            )
            .define("hordeMentality.showHitParticles", true);

    private static final ForgeConfigSpec.IntValue HORDE_MENTALITY_TIER1_MIN_MOBS = BUILDER
            .comment(
                "Minimum group size to break Tier 1 blocks."
            )
            .defineInRange("hordeMentality.tier1MinMobs", 3, 1, 100);

    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> HORDE_MENTALITY_TIER1_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> HORDE_MENTALITY_TIER2_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> HORDE_MENTALITY_TIER3_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> HORDE_MENTALITY_TIER4_BLOCKS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_UNIVERSAL_HOSTILITY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_MENTALITY_WHEN_CHASING_TARGETS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_MENTALITY_DIG_DOWN_FOR_HOSTILITY = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue UNIVERSAL_HOSTILITY_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_PASSIVE_FEAR = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_NEUTRAL_FEAR = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HOSTILE_FEAR = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HORDE_DETERMINATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_DETERMINATION_FOLLOW_DISTANCE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_DETERMINATION_FOLLOW_TIME_MINUTES = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_DETERMINATION_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue MAX_HORDE_GROUP = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_GROUP_MINIMUM = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_WANDERING_DIRECTION_CHANGE_MINUTES = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_WANDERING_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_WANDERING_AVOID_WATER = BUILDER
            .comment("Should wandering groups avoid water?")
            .define("hordeWandering.avoidWater", true);

    private static final ForgeConfigSpec.BooleanValue HORDE_WANDERING_AVOID_FALLS = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLE_HEIGHTENED_SENSE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HEIGHTENED_SENSE_RANGE = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HEIGHTENED_SENSE_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_SIGHT_RANGE_BONUS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_SIGHT_DAYS_BEFORE_ACTIVATION = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.BooleanValue HORDE_SIGHT_INCREASE_OVER_TIME = BUILDER
            .comment(
                "Should the horde mob sight range increase over time?"
            )
            .define("hordeSight.increaseOverTime", false);

    private static final ForgeConfigSpec.IntValue HORDE_SIGHT_INCREASE_INTERVAL_DAYS = BUILDER
            .comment(
    ...
    private static final ForgeConfigSpec.IntValue HORDE_SIGHT_INCREASE_AMOUNT = BUILDER
            .comment(
